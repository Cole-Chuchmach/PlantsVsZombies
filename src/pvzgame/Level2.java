...
public class Level2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        concrete.setBounds(50, 170, 10, 540);
        ...
        sunFlowerPack.setBounds(120, 0, 80, 90);
        ...
        peaStopper.setBounds(1320, 300, 60, 380);
    ...
    private LinkedList<JLabel>  plantPickupLabels2;
    ...
    private void startUp() {
        ...
        plantPickupLabels2 = new LinkedList<>();
    ...
    private void setTimers() {
        ...
        sunFRechargeTimer = new Timer(PEA_RECHARGE_DELAY, new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                sunFlowerRecharge();
            }
        }); 
...
//            zombies.get(current).setLocation(ZOMBIE_SPAWN_X, ZOMBIE_SPAWN_Y);            
    ...
    private void waveZombie2SpawnTime(){
        ...
        if (label != null) {   
            ...
            System.out.println(number);
            if (number <= 1){
                waveZombies.get(waveCurrent2).setLocation(1310, 300);
                zombieMoveTimer.start();
            }
            if (number <= 2 && number > 1){
                waveZombies.get(waveCurrent2).setLocation(1310, 430);
                zombieMoveTimer.start();
            }
            if (number <= 3 && number > 2){
                waveZombies.get(waveCurrent2).setLocation(1310, 560);
                zombieMoveTimer.start();
            }       
        waveCurrent2++;
    ...
    private void zombieMove() {    
        ...
        //System.out.println("zombie move called");
        ...
        for (int zombie = 0; zombie < zombies.size(); zombie++) { 
            ...
            for (int plant = 0; plant < totalPlants; plant++) {
                    ...
                    //newSunFlower = plantPickupLabels.get(plant2);
    ...
    private void waveZombieMove(){
        ...
        try {        
            ...
            // checking all the plants....................................            
            int totalPlants = plantPickupLabels.size();
            int totalPlants2 = plantPickupLabels2.size();
            for (int plant = 0; plant < totalPlants; plant++) {
                for (int plant2 = 0; plant2 < totalPlants2; plant2++) {
                newPeaShooter = plantPickupLabels.get(plant);                
                Rectangle peaShooterHB = getRectangle(newPeaShooter);
                newPeaShooter.setBounds(peaShooterHB.x, 
                                        peaShooterHB.y,
       ...
       for (int i = 0; i < zombies.size(); i++) {    
            ...
            if (p1.intersects(zombieHB)){
                ...
                if (waveProgress >= 100){
                    ...
                    this.dispose();
                    waveProgress = 0;
                    Level2Win complete2 = new Level2Win();
