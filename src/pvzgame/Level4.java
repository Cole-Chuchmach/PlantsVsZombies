...
public class Level4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        concrete.setBounds(40, 170, 10, 640);
        ...
        peaStopper.setBounds(1370, 170, 60, 640);
    ...
    private int       zombieSpawnDelay               = 100;
...
//            zombies.get(current).setLocation(ZOMBIE_SPAWN_X, ZOMBIE_SPAWN_Y);            
    ...
    private void waveZombie2SpawnTime(){
        ...
        if (label != null) {   
            ...
            System.out.println(number);
            if (number <= 1){
                waveZombies2.get(current).setLocation(1310, 170);
                waveZombieMoveTimer.start();
            }
            if (number <= 2 && number > 1){
                waveZombies2.get(current).setLocation(1310, 300);
                waveZombie2MoveTimer.start();
            }
            if (number <= 3 && number > 2){
                waveZombies2.get(current).setLocation(1310, 430);
                waveZombie2MoveTimer.start();
            }
            if (number <= 4 && number > 3){
                waveZombies2.get(current).setLocation(1310, 560);
                waveZombie2MoveTimer.start();
            }
            if (number <= 5 && number > 4){
                waveZombies2.get(current).setLocation(1310, 690);
                waveZombie2MoveTimer.start();
            }       
        waveCurrent2++;
        waveZombie2MoveTimer.start();               
       ...
       for (int i = 0; i < zombies.size(); i++) {    
            ...
            if (p1.intersects(zombieHB)){
                ...
                if (waveProgress >= 100){
                    ...
                    this.dispose();
                    waveProgress = 0;
                    Level4Win complete1 = new Level4Win();
